...
export const INITIAL_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    "chapterId": 7,
    "type": "short-answer",
    "title": "حالة 1: وهن التقارب التكيفي لدى شاب بعمر 20 سنة (Accommodative Asthenopia Case) (سنين سابقة)",
    ...
    "answer": "Diagnosis: ==Simple Hypermetropia (Low degree) (MCQ)==.\n\nExplanation: The constant effort of the ciliary muscle to accommodate and correct this small error causes the ==accommodative asthenopia (MCQ)== (eye strain) described by the patient.",
    "isClinical": false,
    "isPastYear": false,
    "topic": "Past Exams Questions"
  },
  {
    ...
    "chapterId": 7,
    "type": "short-answer",
    "title": "حالة 2: طفل عمره 3 سنوات مع اشتباه حول (Strabismus Evaluation in 3Yo Child) (سنين سابقة)",
    ...
    "answer": "1. ==Visual Acuity Assessment (MCQ)==: Evaluate vision in each eye (e.g., using preferential looking or picture charts) to rule out ==Amblyopia (lazy eye) (MCQ)==.\n2. ==Corneal Light Reflex Test (Hirschberg Test) (MCQ)==: To detect the presence and approximate degree of a manifest squint (tropia).\n3. ==Cover-Uncover & Alternate Cover Tests (MCQ)==: To differentiate between true squint (manifest) and latent squint (phoria), and to identify the type of deviation.\n4. ==Ocular Motility Examination (MCQ)==: To check for any paralyzed or overacting extraocular muscles in all directions of gaze.\n5. ==Cycloplegic Refraction (MCQ)==: Using ==Atropine or Cyclopentolate drops (MCQ)== to measure any refractive error (e.g., high hypermetropia causing accommodative esotropia).\n6. ==Fundus Examination (MCQ)==: To rule out sensory causes of strabismus (e.g., retinoblastoma or congenital cataract).",
    "isClinical": false,
    "isPastYear": false,
    "topic": "Past Exams Questions"
  },
  {
    ...
    "chapterId": 7,
    "type": "short-answer",
    "title": "حالة 3: صعوبة قراءة السبورة لفتى بعمر 14 سنة (Myopia Presentation in Schoolboy) (سنين سابقة)",
    ...
    "answer": "A] Probable Diagnosis: ==Myopia (Short-sightedness) (MCQ)==.\n\nB] Etiology:\n- ==Axial Myopia (MCQ)==: Increased axial length of the globe (most common).\n- ==Curvature Myopia (MCQ)==: Increased curvature of the cornea or lens.\n- ==Index Myopia (MCQ)==: Increased refractive index of the lens nucleus.\n\nTypes:\n- ==Simple Myopia (MCQ)==: Stationary, usually low/moderate, stops progressing around age 18-20.\n- ==Pathological (Degenerative) Myopia (MCQ)==: High progressive myopia associated with degenerative changes in the fundus.\n- ==Congenital Myopia (MCQ)==: Present at birth, usually high and associated with other anomalies.",
    "isClinical": false,
    "isPastYear": false,
    "topic": "Past Exams Questions"
  },
  ...
  },
  {
    ...
    "chapterId": 8,
    "type": "short-answer",
    "title": "تغيرات رأس العصب البصري في الزرق مفتوح الزاوية (ONH changes in POAG) (سنين سابقة)",
  ...
  },
  {
    ...
    "chapterId": 8,
    "type": "short-answer",
    "title": "نظائر البروستاغلاندين لعلاج الزرق (Prostaglandin analogues details) (سنين سابقة)",
  ...
  },
  {
    ...
    "chapterId": 8,
    "type": "short-answer",
    "title": "الزرق الناجم عن تغيرات العدسة (Lens induced glaucomas mechanisms) (سنين سابقة)",
  ...
  },
  {
    ...
    "chapterId": 8,
    "type": "short-answer",
    "title": "العلاجات الطبية للزرق مفتوح الزاوية وآلياتها (Medical lines of POAG therapy) (سنين سابقة)",
  ...
  },
  {
    ...
    "chapterId": 8,
    "type": "short-answer",
    "title": "خطة علاج نوبة الزرق الحاد مغلق الزاوية (Acute angle closure glaucoma approach) (سنين سابقة)",
  ...
  },
  {
    ...
    "chapterId": 8,
    "type": "short-answer",
    "title": "المصطلح العلمي: امتداد البقعة العمياء المنجلي (Sickle shape blind spot expansion term) (سنين سابقة)",
  ...
  },
  {
    ...
    "chapterId": 8,
    "type": "short-answer",
    "title": "النظرية الوعائية لتضرر العصب البصري (Vascular theory of POAG damage) (سنين سابقة)",
  ...
  },
  {
    ...
    "chapterId": 8,
    "type": "short-answer",
    "title": "سبب تأجيل الميوتك في الزرق الحاد مغلق الزاوية (Pilocarpine restriction in acute attack) (سنين سابقة)",
  ...
  },
  {
    ...
    "chapterId": 8,
    "type": "short-answer",
    "title": "حالة 1: طفل عمره 6 أشهر بقرنية غائمة وكبيرة (Congenital glaucoma buphthalmos case) (سنين سابقة)",
  ...
  },
  {
    ...
    "chapterId": 8,
    "type": "short-answer",
    "title": "حالة 2: مريض 50 سنة بارتفاع ضغط عين غير متماثل (Asymmetric POAG presentation case) (سنين سابقة)",
  ...
  },
  {
    ...
    "chapterId": 8,
    "type": "short-answer",
    "title": "حالة 3: طفل بعمر سنة وعين يمنى تبدو أكبر (Child with suspected larger right eye case) (سنين سابقة)",
  ...
  },
  {
    ...
    "chapterId": 8,
    "type": "short-answer",
    "title": "حالة 4: صداع وتقيؤ حاد لامرأة بعد فحص قاع العين (Post-fundus exam acute closure case) (سنين سابقة)",
  ...
  },
  {
    ...
    "chapterId": 8,
    "type": "short-answer",
    "title": "حالة 5: مريض 52 سنة يشكو من صداع مع ارتفاع ضغط العين (POAG headache & evaluation) (سنين سابقة)",
  ...
  },
  {
    ...
    "chapterId": 8,
    "type": "short-answer",
    "title": "أكمل 1: رؤية الشبكة التربيقية في نظام شافر (Shaffer grade II gonioscopy visibility) (سنين سابقة)",
  ...
  },
  {
    ...
    "chapterId": 8,
    "type": "short-answer",
    "title": "أكمل 2: توعي قزحية العين يسبب زرق وعائي (Neovascular glaucoma mechanism) (سنين سابقة)",
  ...
  },
  {
    ...
    "chapterId": 8,
    "type": "short-answer",
    "title": "أكمل 3: الحافة العصبية الشبكية المحيطة بالتقعر (Area containing nerve fibers term) (سنين سابقة)",
  ...
  },
  {
    ...
    "content": "List 3 signs of pre-proliferative diabetic retinopathy.",
    "answer": "1. ==Venous abnormalities (venous beading, looping, or reduplication) (MCQ)==.\n2. ==Intraretinal Microvascular Abnormalities (IRMA) (MCQ)==.\n3. ==Multiple cotton-wool spots (soft exudates) (MCQ)==.\n4. Extensive, large deep retinal hemorrhages.",
    "isClinical": true,
    "topic": "Hypertensive & Diabetic Retinopathy"
  },
  {
  ...
  },
  {
    ...
    "chapterId": 9,
    "type": "short-answer",
    "title": "Types and Common Causes of Uveitis",
    "content": "List the types (anatomical classification) and the common causes of uveitis.",
    "answer": "==Types of Uveitis (Anatomical Classification)==:\\\\n1. ==Anterior Uveitis== (Iritis, Iridocyclitis) - Most common.\\\\n2. ==Intermediate Uveitis== (Pars planitis).\\\\n3. ==Posterior Uveitis== (Choroiditis, Chorioretinitis).\\\\n4. ==Panuveitis== (affects all uveal parts).\\\\n\\\\n==Common Causes==:\\\\n- ==Infective==: Bacterial (e.g., ==Syphilis==, ==TB==), Viral (e.g., ==Herpes simplex/zoster==, ==Cytomegalovirus==), Fungal (e.g., ==Histoplasmosis==, ==Candida==), Parasitic (e.g., ==Toxoplasmosis==).\\\\n- ==Autoimmune/Systemic diseases==: ==Ankylosing spondylitis==, ==Rheumatoid arthritis==, ==Behçet\\'s disease==, ==Sarcoidosis==, ==Vogt-Koyanagi-Harada syndrome==.\\\n- ==Trauma==: Penetrating injuries or blunt trauma.\\\n- ==Idiopathic==: No identifiable cause (==the most common category==).",
    "isClinical": false,
  ...
  },
  {
    ...
    "content": "Describe the changes in the pupil in acute and chronic iridocyclitis.",
    "answer": "- ==In Acute Iridocyclitis==: The pupil is ==small (miotic)== due to the irritating effect of toxins on the ==sphincter pupillae== muscle, and its reaction to light is ==sluggish==.\\\n- ==In Chronic Iridocyclitis==: The pupil becomes ==irregular (festooned pupil)== due to the formation of localized ==posterior synechiae== (adhesions between the inflamed iris and the anterior lens capsule). If the synechiae are complete, it causes ring synechia (==seclusio pupillae==).",
    "isClinical": false,
  ...
  },
  {
    ...
    "chapterId": 9,
    "type": "short-answer",
    "title": "Mechanism of Diminution of Vision in Acute Iridocyclitis",
    "content": "Explain the mechanism of diminution of vision in acute iridocyclitis.",
    "answer": "Vision diminishes due to several factors:\\\n1. ==Turbidity of the aqueous humor== (flare and cells) due to protein and cell leakage.\\\n2. ==Corneal edema== (due to endothelial dysfunction from inflammation).\\\n3. ==Heavy exudates== covering the pupil (==occlusio pupillae==) or dropping down (==hypopyon==).\\\n4. ==Spasm of the ciliary muscle== (causing induced myopia).\\\n5. ==Secondary complications== like complicated cataract, secondary glaucoma, or cystoid macular edema (in severe or chronic cases).",
    "isClinical": false,
    "topic": "Anterior Uveitis (Iridocyclitis)"
  },
  {
    ...
    "chapterId": 9,
    "type": "short-answer",
    "title": "Definition & Differential Diagnosis of Panophthalmitis",
    "content": "Mention the definition and differential diagnosis of panophthalmitis.",
    "answer": "==Definition==:\\\nIt is an acute, severe, ==purulent panuveitis== (suppurative inflammation) involving ==all coats of the eye== (uvea, retina, sclera) and extending to the ==orbital tissues== (Tenon\\'s capsule).\\\\n\\\\n==Differential Diagnosis==:\\\\n1. ==Endophthalmitis==: Purulent inflammation of the intraocular cavities (uvea and retina) ==without involving the sclera or orbital tissues==. Ocular motility is ==normal== and there is ==no proptosis==.\\\\n2. ==Orbital Cellulitis==: Infection of the orbital soft tissues. It has ==proptosis== and ==limited motility== but the eye itself (cornea, anterior chamber, red reflex) remains ==initially clear==.",
    "isClinical": false,
  ...
  },
  {
    ...
    "chapterId": 9,
    "type": "short-answer",
    "title": "Explanation: Rapid Diminution of Vision in Acute Iridocyclitis",
    "content": "Explain the occurrence of rapid diminution of vision in acute iridocyclitis.",
    "answer": "Due to the sudden ==leakage of inflammatory cells and protein-rich exudates (flare)== into the anterior chamber, which ==clouds the aqueous humor==. Additionally, ==inflammatory corneal edema== and ==heavy keratic precipitates== obscure the visual axis.",
    "isClinical": false,
    "topic": "Anterior Uveitis (Iridocyclitis)"
  },
  {
    ...
    "chapterId": 9,
    "type": "short-answer",
    "title": "Explanation: Why Enucleation is Contraindicated in Panophthalmitis",
    "content": "Explain why enucleation is contraindicated in panophthalmitis.",
    "answer": "Because enucleation involves cutting the optic nerve and its sheaths. In the presence of severe purulent infection involving the sclera and orbital tissues (panophthalmitis), cutting the nerve sheath opens a ==direct pathway for the infection to travel to the subarachnoid space==, leading to ==fatal purulent meningitis==. The correct procedure is ==Evisceration== (removing the intraocular contents while leaving the sclera intact).",
    "isClinical": false,
    "topic": "Suppurative Uveitis (Endophthalmitis & Panophthalmitis)"
  },
  {
    ...
    "chapterId": 9,
    "type": "short-answer",
    "title": "Anterior Chamber Signs, Complications, and Treatment of Acute Iridocyclitis",
    "content": "For Acute Iridocyclitis:\\\\nA] What are the anterior chamber signs?\\\\nB] What are the complications of anterior uveitis?\\\\nC] What are the drugs used in the treatment of an acute attack?",
    "answer": "==A] Anterior Chamber Signs==:\\\\n- ==Aqueous flare== (protein leakage)\\\\n- ==Aqueous cells==\\\\n- ==Hypopyon== (in severe purulent cases)\\\\n- ==Keratic precipitates (KPs)== on the corneal endothelium\\\\n- Altered anterior chamber depth (deep at first, or variable if synechiae form).\\\\n\\\\n==B] Complications of Anterior Uveitis==:\\\\n- ==Complicated cataract==\\\\n- ==Secondary glaucoma==\\\\n- ==Posterior synechiae== (leading to seclusio and occlusio pupillae)\\\\n- ==Band keratopathy==\\\\n- ==Cystoid macular edema==\\\\n- ==Phthisis bulbi== (in end-stages).\\\\n\\\\n==C] Drugs Used in Treatment of Acute Attack==:\\\\n1. ==Topical Cycloplegics/Mydriatics== (e.g., Atropine 1%) to relieve pain, break synechiae, and rest the ciliary muscle.\\\\n2. ==Topical Corticosteroids== (e.g., Dexamethasone or Prednisolone) to severely suppress inflammation.\\\\n3. ==Systemic NSAIDs== for pain relief.",
    "isClinical": false,
    "topic": "Anterior Uveitis (Iridocyclitis)"
  },
  {
    ...
    "chapterId": 9,
    "type": "short-answer",
    "title": "Case Study 1: Acute Headache and Unilateral Constricted Pupil",
    "content": "A 45-year-old female presented in the emergency room with intensive headache for the last 5 hours accompanied by a drop in vision in her right eye. She reported having one similar attack before in the same eye. The pupil was markedly constricted on the right side.",
    "answer": "Diagnosis: ==Acute Anterior Uveitis (Acute Iridocyclitis)==. The ==constricted pupil== differentiates it from acute angle-closure glaucoma (which presents with a ==mid-dilated pupil==).",
    "isClinical": true,
    "topic": "Anterior Uveitis (Iridocyclitis)"
  },
  {
    ...
    "chapterId": 9,
    "type": "short-answer",
    "title": "Case Study 2: Recurrent Pain, Redness, Joint Pain",
    "content": "A middle-aged female with recurrent joint pain gave a past history of recurrent attacks of pain, redness and dropped vision in one eye. Recently she complained of a similar attack.",
    "answer": "Diagnosis: ==Recurrent Acute Anterior Uveitis== associated with a ==systemic autoimmune joint disease== (e.g., ==Ankylosing spondylitis== or ==Rheumatoid arthritis==).",
    "isClinical": true,
    "topic": "Anterior Uveitis (Iridocyclitis)"
  },
  {
    ...
    "chapterId": 9,
    "type": "short-answer",
    "title": "Case Study 3: Postoperative Pain, Retained Lens Material, High IOP",
    "content": "A 64-year-old female, who had cataract surgery 3 days before, presented with a red painful eye with decreasing vision. On examination, the eye was severely injected, severe corneal edema, 4 plus cells and flare in the anterior chamber, cortical lens matter in the anterior chamber, and the intraocular pressure of 40 mmHg.",
    "answer": "Diagnosis: ==Phacoanaphylactic Glaucoma== (or Phacotoxic secondary glaucoma) combined with ==severe postoperative anterior uveitis==, triggered by ==retained cortical lens matter== in the anterior chamber.",
    "isClinical": true,
    "topic": "Anterior Uveitis (Iridocyclitis)"
  },
  {
    ...
    "chapterId": 9,
    "type": "short-answer",
    "title": "Case Study 4: Postoperative Diabetic Drop in Vision",
    "content": "A 23-year-old diabetic female complaining of acute onset of left rapid drop of vision, red eye, photophobia, lacrimation and blepharospasm for 1 week after surgery for cataract extraction and IOL implantation.\\\\nA] What is your presumed diagnosis?\\\\nB] What will you see in her examination?\\\\nC] Enumerate lines of treatment of this case.",
    "answer": "==A] Presumed Diagnosis==:\\\\n- ==Acute Postoperative Endophthalmitis==.\\\\n\\\\n==B] Examination Findings==:\\\\n- ==Severe ciliary injection==\\\\n- ==Corneal edema==\\\\n- ==Dense flare and cells== in the anterior chamber\\\\n- ==Hypopyon== (pus layer)\\\\n- ==Loss of the red reflex== (due to vitreous exudates/vitritis).\\\\n\\\\n==C] Lines of Treatment==:\\\\n1. Urgent ==Intravitreal antibiotics== (e.g., ==Vancomycin and Ceftazidime==) and topical intensive fortified antibiotics.\\\\n2. If the vision is ==Light Perception only (PL)==, urgent ==Pars Plana Vitrectomy (PPV)== is indicated.",
    "isClinical": true,
    "topic": "Suppurative Uveitis (Endophthalmitis & Panophthalmitis)"
  },
  {
    ...
    "chapterId": 9,
    "type": "short-answer",
    "title": "Case Study 5: Diabetic Postoperative Yellowish Pupil",
    "content": "A 62-year-old female diabetic patient presented complaining of rapid drop of vision and severe pain in her left eye, 2 weeks after routine cataract extraction and IOL implantation. On examination: visual acuity was light perception in the left eye, there is severe red eye, yellowish pupil and hypopyon.\\\\nA) What is the most probable diagnosis?\\\\nB) Choose one important investigation:\\\\nC) In this case, the most relevant surgical intervention is:",
    "answer": "==A) Most probable diagnosis==:\\\\n- ==Bacterial endophthalmitis==.\\\\n\\\\n==B) Important investigation==:\\\\n- ==B-scan ultrasound==. (To detect vitreous opacities since the fundus cannot be seen through the yellowish pupil/hypopyon).\\\\n\\\\n==C) Most relevant surgical intervention==:\\\\n- ==Vitrectomy==. (Indicated because the vision has dropped to Light Perception).",
    "isClinical": true,
    "topic": "Suppurative Uveitis (Endophthalmitis & Panophthalmitis)"
  },
  {
    ...
    "chapterId": 9,
    "type": "short-answer",
    "title": "Case Study 6: Unilateral Redness, Precipitates, High IOP",
    "content": "A 30-year-old female came to the health service complaining of rapid onset of blurring of vision of left eye with dull pain radiating to the eyebrow since 2 days. You examined her and you found that visual acuity in right eye was 6/6 and in the left eye was 6/18 which was not improved by pin hole. Intraocular pressure (IOP) was 16 mmHg in right eye and 20 mmHg in left eye. There were white precipitates on the back of the left cornea with deep turbid anterior chamber by slit lamp. The pupil was narrow with sluggish reaction.\\\\na) What is your diagnosis?\\\\nb) Enumerate probable causes for diminution of vision in left eye.\\\\nc) Explain the higher IOP in the affected eye.\\\\nd) Enumerate lines of treatment of this case.",
    "answer": "==a) Diagnosis==:\\\\n- ==Acute Anterior Uveitis (Acute Iridocyclitis)==.\\\\n\\\\n==b) Causes of Diminution of Vision==:\\\\n- ==Turbidity of aqueous== (flare and cells), ==corneal edema==, and ==keratic precipitates (KPs)==.\\\\n\\\\n==c) Reason for Higher IOP==:\\\\n- The IOP is slightly elevated because ==inflammatory cells and proteinaceous debris (flare) clog the trabecular meshwork== (Secondary open-angle glaucoma/hypertensive uveitis).\\\\n\\\\n==d) Lines of Treatment==:\\\\n- ==Topical Cycloplegics== (Atropine 1%) to dilate the pupil and break synechiae.\\\\n- ==Topical Corticosteroids== (Prednisolone acetate 1%).\\\\n- ==Systemic analgesics/NSAIDs==.",
    "isClinical": true,
    "topic": "Anterior Uveitis (Iridocyclitis)"
  },
  {
    ...
    "chapterId": 9,
    "type": "short-answer",
    "title": "Case Study 7: Bilateral Redness and Oral/Genital Ulcers",
    "content": "Old male patient came to you with acute onset of bilateral red eye with pain in the temple and periocular area. He has a history of previous similar attack 6 months ago. As well he has recurrent oral and genital ulcers. On examination, best corrected visual acuity was 6/9 in right eye and 6/12 in left eye. Intra-ocular pressure was 14 mmHg in both eyes. There was bilateral ciliary injection and mild eyelid edema. There were bilateral liquid hypopyon, and iris pigments on the anterior lens capsule with posterior synechia in the right eye at 8 o\\'clock position.\\\nA] What is your diagnosis of the ocular condition?\\\nB] What is the systemic syndrome the patient may suffer from?\\\nC] How will you manage this case?",
    "answer": "==A] Diagnosis of Ocular Condition==:\\\n- ==Recurrent Bilateral Acute Anterior Uveitis with Hypopyon==.\\\n\\\n==B] Systemic Syndrome==:\\\n- ==Behçet\\'s Disease==.\\\\n\\\\n==C] Management==:\\\\n- ==Topical Cycloplegics== (Atropine), ==Intensive Topical Corticosteroids==, and referral to a rheumatologist/internist for ==systemic immunosuppressive therapy== (e.g., systemic steroids or cyclosporine) to control the underlying Behçet\\'s disease.",
    "isClinical": false,
    "topic": "Anterior Uveitis (Iridocyclitis)"
  },
  {
    ...
    "chapterId": 9,
    "type": "short-answer",
    "title": "Dry Eye, Dry Mouth, and Poly-arthritis Syndrome",
    "content": "The syndrome of dry eye with dry mouth and poly-arthritis is called .........",
  ...
  },
  {
    ...
    "chapterId": 9,
    "type": "short-answer",
    "title": "Ciliary Muscle and Sphincter Spasm Effects",
    "content": "In acute iridocyclitis, spasm of sphincter pupillae muscle leads to ......... & spasm of ciliary muscle leads to ......... and pain.",
    "answer": "==Miosis== (constricted pupil) & ==Accommodative spasm== (induced myopia).",
    "isClinical": false,
    "topic": "Anterior Uveitis (Iridocyclitis)"
  },
  {
  ...
  },
  {
    ...
    "content": "Explain the surgical options and principles for Pterygium excision.",
    "answer": "1) ==Simple excision==: with the edges of conjunctiva are sutured ==without any raw area==. It has a high degree of recurrence.\\n2) ==Excision with bare sclera==: The pterygium is excised leaving a ==raw area of sclera== allowing the corneal epithelium to cover the bared cornea before the conjunctival epithelium.",
    "isClinical": false,
    "isSurgical": true,
    "topic": "Conjunctival Degenerations & Symblepharon (Pterygium & Pinguecula)"
  },
  {
    ...
    "chapterId": 4,
    "type": "short-answer",
    "title": "Surgical Principle: Central perforated corneal ulcers (Corneal fistula)",
    "content": "What is the surgical principle of Chauffage in Central perforated corneal ulcers (Corneal fistula)?",
    "answer": "==Chauffage==: ==indirect thermal cautery== close to the fistula to destroy the epithelial lining of wall of the ulcer.",
    "isClinical": false,
    "isSurgical": true,
    "topic": "Hypopyon Ulcer (Acute Serpiginous Ulcer)"
  },
  ...
  },
  {
    ...
    "chapterId": 6,
    "type": "short-answer",
    "title": "Surgical Principle: Orbital decompression (Optic Neuropathy)",
    "content": "What is the surgical principle of Orbital decompression in advanced cases of Thyroid Eye Disease?",
    "answer": "==Orbital decompression==: Orbital decompression in advanced cases “e.g. ==Optic neuropathy==”.",
    "isClinical": false,
    "isSurgical": true,
    "topic": "Surgical Operations of the Orbit"
  },
  ...
  },
  {
    ...
    "answer": "- ==Resection==: shortens the muscle---==increase power==.\\n- ==Advancement==: carrying the insertion ==anterior==.\\n- ==Plication==: ==Tightening its fibers==.\\n- ==Recession==: carrying the insertion ==backward==.",
    "isClinical": false,
    "isSurgical": true,
    "topic": "Apparent Squint & Latent Squint (Heterophoria)"
  },
  ...
  },
  {
    ...
    "answer": "==excision with/without graft==, graft can be ==mucous membrane== or ==amniotic membrane==.",
    "isClinical": false,
    "isSurgical": true,
    "topic": "Conjunctival Degenerations & Symblepharon (Pterygium & Pinguecula)"
  },
  ...
  },
  {
    ...
    "chapterId": 1,
    "type": "short-answer",
    "title": "Surgical Principle: Ptosis evaluation & action choice",
    "content": "Decide on the surgical choice for Ptosis depending on the action and power of the levator muscle.",
    "answer": "- if levator has ==some action==: ==resection & advancement==\\n- if levator is ==poor & severe==: ==connect the eyelid to the brow with a sling== depending on the power of the ==frontalis muscle== in elevation.",
    "isClinical": false,
    "isSurgical": true,
    "topic": "Assessment and Treatment of Ptosis"
  },
  {
    ...
    "answer": "==complete removal of NLD==.",
    "isClinical": false,
    "isSurgical": true,
    "topic": "Acute & Chronic Dacryocystitis"
  },
  ...
  },
  {
    ...
    "chapterId": 12,
    "type": "short-answer",
    "title": "Surgical Principle: Optic nerve decompression",
    "content": "What is the surgical principle of Optic nerve decompression to treat threatening papilledema?",
    "answer": "==fenestration of parts of O.N== to relieve threatening papilledema.",
    "isClinical": false,
    "isSurgical": true,
    "topic": "Optic Disc Swelling Differential Diagnosis (Optic Neuritis, Papilledema, NAION)"
  },
