...
,
  ...
  // ===========================================================================
  // --- NEW QUESTIONS FROM support Ophthalmology GNO Full edition (2) ---
  // ===========================================================================

  // --- Chapter 1: Eyelid (18 Questions) ---
  {
    id: "gno_eyelid_anatomy_q1",
    chapterId: 1,
    type: "short-answer",
    title: "Eyelid Histological Layers",
    content: "Enumerate the six histological layers of the eyelid from outside inwards.",
    answer: `1. The skin (thin, elastic, containing no fat).
2. The subcutaneous areolar tissue (containing no fat).
3. The muscle layer (striated: orbicularis oculi and LPS; non-striated: Muller's muscle and lower lid retractors).
4. The submuscular areolar tissue.
5. The fibrous layer (composed of the tarsal plates and the orbital septum).
6. The palpebral conjunctiva (firmly adherent to the tarsus).`,
    isClinical: false,
    topic: "Anatomy & Physiology of the Eyelid"
  },
  {
    id: "gno_eyelid_anatomy_q2",
    chapterId: 1,
    type: "short-answer",
    title: "Grey Line of Eyelid Margin",
    content: "Define the Grey Line of the eyelid margin and state its anatomical and surgical significance.",
    answer: `Definition: A line running along the lid margin corresponding to the neurovascular bundle between the orbicularis muscle and the tarsus, lying between the ciliary (anterior) and Meibomian gland (posterior) borders.

Anatomical Significance: Represents the boundary separating the anterior lamella (skin and muscle) from the posterior lamella (tarsus and conjunctiva).

Surgical Significance: The eyelid can be surgically split along the grey line into anterior and posterior lamellae, which is a key step in operations correcting distichiasis, trichiasis, or lid malpositions.`,
    isClinical: false,
    topic: "Anatomy & Physiology of the Eyelid"
  },
  {
    id: "gno_eyelid_anatomy_q3",
    chapterId: 1,
    type: "short-answer",
    title: "Submuscular Areolar Tissue and Local Anesthesia",
    content: "Explain the clinical significance of the submuscular areolar tissue in administering local anesthesia to the eyelid.",
    answer: `Location and Contents: The submuscular areolar tissue lies deep to the orbicularis muscle and superficial to the tarsal plate. It contains the peripheral arterial arcade and the main sensory nerves to the eyelid.

Anesthesia Significance: Due to the presence of these primary sensory nerve branches in this space, it is necessary to inject local anesthetic deep to the orbicularis oculi muscle to achieve complete and effective sensory anesthesia of the eyelid.`,
    isClinical: true,
    topic: "Anatomy & Physiology of the Eyelid"
  },
  {
    id: "gno_eyelid_anatomy_q4",
    chapterId: 1,
    type: "short-answer",
    title: "Tarsal Plates & Meibomian Glands Structure",
    content: "Describe the structure, height dimensions of the tarsal plates, and details of the Meibomian glands embedded within them.",
    answer: `Tarsal Plates Structure: Dense fibrous tissue plates that form the structural skeleton of the eyelids. Medially and laterally, they fuse with the canthal tendons (palpebral ligaments).

Dimensions:
- Upper tarsus: 8–12 mm in height.
- Lower tarsus: 4–5 mm in height.

Meibomian Glands: Elongated sebaceous glands embedded vertically within the tarsal plates. There are approximately 30 glands in the upper lid and 25 glands in the lower lid. Their orifices open on the lid margin behind the grey line to secrete the oily lipid layer of the tear film.`,
    isClinical: false,
    topic: "Anatomy & Physiology of the Eyelid"
  },
  {
    id: "gno_eyelid_anatomy_q5",
    chapterId: 1,
    type: "short-answer",
    title: "Orbital Septum Anatomy & Function",
    content: "Define the orbital septum, detail its attachments, and explain its clinical function.",
    answer: `Definition: A thin fibrous membrane that acts as a boundary diaphragm separating the eyelids from the orbit.

Attachments: Arises from the periosteum of the orbital rim (arcus marginalis). It inserts into the levator aponeurosis in the upper eyelid and into the inferior tarsal border in the lower eyelid.

Function: Keeps the orbital fat pad contained within the orbit and acts as a barrier that prevents superficial preseptal infections (cellulitis) from spreading posteriorly into the orbit (orbital cellulitis).`,
    isClinical: false,
    topic: "Anatomy & Physiology of the Eyelid"
  },
  {
    id: "gno_eyelid_anatomy_q6",
    chapterId: 1,
    type: "short-answer",
    title: "LPS Muscle Origin and Insertions",
    content: "State the origin, action, and four insertion points of the Levator Palpebrae Superioris (LPS) muscle.",
    answer: `Origin: Lesser wing of the sphenoid bone at the apex of the orbit.

Action: Elevates the upper eyelid.

Insertions:
1. Main Insertion: On the anterior surface of the tarsal plate.
2. Skin Insertion: 2 mm below the superior palpebral furrow (eyelid crease).
3. Canthal Insertion: Lateral and medial horns into the orbital margins near the canthal ligaments.
4. Fornix Insertion: Into the upper conjunctival fornix.`,
    isClinical: false,
    topic: "Anatomy & Physiology of the Eyelid"
  },
  {
    id: "gno_eyelid_anatomy_q7",
    chapterId: 1,
    type: "short-answer",
    title: "Muller's Muscle Anatomy & Innervation",
    content: "Describe the origin, insertion, action, and innervation of Muller's muscle.",
    answer: `Origin: Arises from the posterior aspect of the levator palpebrae superioris muscle.

Insertion: Into the superior tarsal border.

Action: Sustains and maintains the elevation of the upper eyelid.

Innervation: Innervated by the sympathetic nervous system. Paralysis of this muscle leads to mild sympathetic ptosis, as seen in Horner's syndrome.`,
    isClinical: false,
    topic: "Anatomy & Physiology of the Eyelid"
  },
  {
    id: "gno_eyelid_anatomy_q8",
    chapterId: 1,
    type: "short-answer",
    title: "Lymphatic Drainage of the Eyelid",
    content: "Describe the lymphatic drainage pathways of the eyelids.",
    answer: `Drainage pathways are divided anatomically:
- Lateral part of the eyelids: Drains into the preauricular and parotid lymph nodes.
- Medial part of the eyelids: Drains into the submandibular lymph nodes.
- Final Common Pathway: Both systems eventually drain into the upper deep cervical lymph nodes.`,
    isClinical: false,
    topic: "Anatomy & Physiology of the Eyelid"
  },
  {
    id: "gno_eyelid_blepharitis_q1",
    chapterId: 1,
    type: "short-answer",
    title: "Posterior Blepharitis (Meibomian Gland Dysfunction)",
    content: "Define Posterior Blepharitis and mention its etiology and clinical difference from Anterior Blepharitis.",
    answer: `Definition: Chronic inflammation of the Meibomian glands, leading to meibomian gland dysfunction (MGD).

Etiology: Duct obstruction secondary to hyperkeratinization of the ductal epithelium, associated with acne rosacea or seborrheic dermatitis.

Clinical Difference:
- Anterior Blepharitis: Inflammation at the base of the lashes (squamous or ulcerative).
- Posterior Blepharitis: Inflammation of the glands inside the tarsus, presenting with plugged orifices, hyperemic lid margins, frothy tears, and secondary dry eyes due to lipid deficiency.`,
    isClinical: true,
    topic: "Blepharitis"
  },
  {
    id: "gno_eyelid_blepharitis_q2",
    chapterId: 1,
    type: "short-answer",
    title: "Tylosis (Ptylosis) Definition and Vicious Circle",
    content: "Define Tylosis (Ptylosis) of the eyelid margin and explain how it leads to a clinical vicious circle.",
    answer: `Definition: A complication of chronic blepharitis characterized by hypertrophy and thickening of the eyelid margin.

Pathogenesis: The thickening destroys the sharp posterior border of the lid margin. This disrupts the apposition of the lid against the globe, causing epiphora.

Vicious Circle: Epiphora triggers an eczematous reaction of the skin -> Skin eczema leads to scarring -> Scarring causes cicatricial ectropion -> Ectropion worsens punctal eversion and epiphora -> This cycle continuously self-perpetuates.`,
    isClinical: true,
    topic: "Blepharitis"
  },
  {
    id: "gno_eyelid_glands_q1",
    chapterId: 1,
    type: "short-answer",
    title: "Differential Diagnosis of Chalazion",
    content: "Enumerate three important differential diagnoses that must be considered for a Chalazion.",
    answer: `1. Sebaceous gland carcinoma (Adenocarcinoma of the Meibomian gland): Must be excluded in elderly patients with recurrent chalazia via biopsy.
2. Sebaceous cyst: Located in the eyelid skin and moves with the skin, whereas a chalazion is embedded in the tarsal plate.
3. Chronic infectious granulomas: Tuberculoma (tuberculosis) or Gumma (syphilis).`,
    isClinical: true,
    topic: "Inflammations of the Eyelid Glands (Hordeolum & Chalazion)"
  },
  {
    id: "gno_eyelid_positional_q1",
    chapterId: 1,
    type: "short-answer",
    title: "Spastic Entropion Management",
    content: "Describe the temporary and permanent treatment modalities for Spastic Entropion.",
    answer: `Temporary Modalities:
1. Treat the predisposing acute ocular inflammation or corneal irritation.
2. Apply T-shaped adhesive plaster to mechanically pull the lower lid outward.
3. Inject Botulinum toxin (Botox) into the orbicularis muscle to induce temporary chemical paralysis.
4. Place everting mattress sutures (starting at the lower fornix and tied on the skin below the margin).

Permanent Modalities (for chronic resistant cases):
- Skin and muscle operation: Excision of an elliptical strip of skin and the underlying muscle of Riolan close to the lid margin.`,
    isClinical: true,
    topic: "Positional Anomalies (Entropion & Ectropion)"
  },
  {
    id: "gno_eyelid_positional_q2",
    chapterId: 1,
    type: "short-answer",
    title: "Surgical Management of Senile Ectropion",
    content: "Outline the surgical choices for correcting Senile Ectropion according to its clinical severity.",
    answer: `Choices depend on severity:
- Mild Senile Ectropion: Cautery puncture of the conjunctival side (heals with subconjunctival cicatricial contraction that pulls the margin back inward).
- Moderate Senile Ectropion: Snellen's everting/inverting sutures.
- Severe Senile Ectropion: Dimmer's modification of the Kuhnt operation (or Kuhnt-Szymanowski operation to shorten the lid horizontally).`,
    isClinical: true,
    topic: "Positional Anomalies (Entropion & Ectropion)"
  },
  {
    id: "gno_eyelid_positional_q3",
    chapterId: 1,
    type: "short-answer",
    title: "Surgical Options for Permanent Paralytic Ectropion",
    content: "Enumerate five surgical options for treating permanent Paralytic Ectropion caused by facial nerve palsy.",
    answer: `1. Tarsorrhaphy: Stitching the lid margins (lateral or median) to narrow the palpebral fissure.
2. Canthoplasty: Shortening the medial or lateral canthal tendons.
3. Lateral tarsal strip: Re-fixing the lateral tarsus to the lateral canthal tendon.
4. Subcutaneous fascia lata or silicon sling: Encircling the lid, fixed medially to the canthal tendon and laterally to the temporalis fascia.
5. Silicon sling encircling the eyelid.`,
    isClinical: true,
    topic: "Positional Anomalies (Entropion & Ectropion)"
  },
  {
    id: "gno_eyelid_lago_q1",
    chapterId: 1,
    type: "short-answer",
    title: "Degrees of Lagophthalmos",
    content: "Contrast between the mild and severe clinical degrees of Lagophthalmos.",
    answer: `- Mild Lagophthalmos: The patient can close the eyelids fully on voluntary forcible squeezing, but the palpebral fissure remains open during sleep (involuntary closure is deficient).
- Severe Lagophthalmos: The eyelids cannot close completely even with maximum voluntary squeezing effort, leaving the cornea exposed.`,
    isClinical: true,
    topic: "Lagophthalmos"
  },
  {
    id: "gno_eyelid_ptosis_q1",
    chapterId: 1,
    type: "short-answer",
    title: "Marcus Gunn Jaw-Winking Phenomenon",
    content: "Define the Marcus Gunn Jaw-Winking phenomenon and explain its underlying neural pathogenesis.",
    answer: `Definition: A congenital synkinetic ptosis where the drooping upper eyelid elevates rapidly on moving the jaw (e.g., during chewing or sucking).

Pathogenesis: Caused by a congenital aberrant neural connection (mishwiring) between the motor branch of the trigeminal nerve (CN V3, supplying the external pterygoid mastication muscle) and the motor branch of the oculomotor nerve (CN III, supplying the levator palpebrae superioris muscle).`,
    isClinical: true,
    topic: "Assessment and Treatment of Ptosis"
  },
  {
    id: "gno_eyelid_ptosis_q2",
    chapterId: 1,
    type: "short-answer",
    title: "Complications of Untreated Congenital Ptosis",
    content: "List three clinical complications that can develop in long-standing untreated Congenital Ptosis.",
    answer: `1. Deprivation Amblyopia (lazy eye): Caused by the drooped lid completely covering the pupil, preventing light stimulus from reaching the retina during critical visual development.
2. Ocular Torticollis: Abnormal head tilting and neck muscle contraction (sternocleidomastoid muscle) as the child tries to see under the drooping eyelids.
3. Secondary strabismus (concomitant or paralytic squint).`,
    isClinical: true,
    topic: "Assessment and Treatment of Ptosis"
  },
  {
    id: "gno_eyelid_ptosis_q3",
    chapterId: 1,
    type: "short-answer",
    title: "Contraindications to Ptosis Surgery",
    content: "Enumerate four major clinical contraindications to performing Ptosis surgery.",
    answer: `1. Recent complete 3rd nerve palsy: Ptosis covers the squinting eye, preventing diplopia. Correcting ptosis before squint surgery would cause severe double vision.
2. Ptosis associated with neuroparalytic keratitis or absent Bell's phenomenon: High risk of exposure keratitis postoperatively.
3. Myasthenic ptosis: Handled medically with anticholinesterase drugs (Prostigmin) rather than surgery.
4. Corneal anesthesia: The absence of corneal sensation and blink reflex makes postoperative exposure ulceration extremely dangerous.`,
    isClinical: true,
    topic: "Assessment and Treatment of Ptosis"
  },

  // --- Chapter 2: Lacrimal System (5 Questions) ---
  {
    id: "gno_lacrimal_water_q1",
    chapterId: 2,
    type: "short-answer",
    title: "Jones Dye Tests for Epiphora",
    content: "Explain the method and interpretation of the Jones Primary (Type I) and Secondary (Type II) Dye Tests.",
    answer: `Jones Type I (Primary) Test:
- Method: Instill 2% fluorescein into the conjunctival sac. Place a local anesthetic-soaked cotton pellet under the inferior turbinate in the nose.
- Interpretation: If the cotton is stained with dye within 5 minutes, the test is positive (passages are patent). If not stained, the test is negative; proceed to Type II.

Jones Type II (Secondary) Test:
- Method: Irrigate the lacrimal system with clear saline through a cannula.
- Interpretation:
  * If fluorescein-stained saline is recovered from the nose, there is a functional/partial obstruction of the nasolacrimal duct (fluid entered the sac but didn't pass dynamically).
  * If clear saline is recovered, the dye never entered the sac, indicating a proximal block (punctal/canalicular stenosis).
  * If no fluid reaches the nose, there is a complete NLD block.`,
    isClinical: true,
    topic: "Clinical Approach & Workup of Watering (Epiphora)"
  },
  {
    id: "gno_lacrimal_water_q2",
    chapterId: 2,
    type: "short-answer",
    title: "Dacryocystography (DCG) vs. Dacryoscintigraphy",
    content: "Differentiate between Dacryocystography (DCG) and Dacryoscintigraphy regarding their techniques and clinical indications.",
    answer: `- Dacryocystography (DCG): Involves injecting radiopaque contrast dye into the canaliculi followed by X-ray or CT imaging. Indicated for defining the exact anatomical site and structure of mechanical obstructions.
- Dacryoscintigraphy: A non-invasive nuclear test using radioactive tracer drops (Technetium-99m) in the eyes. Indicated for assessing tear flow under physiological conditions to diagnose functional epiphora (e.g., pump failure or partial mucosal swelling).`,
    isClinical: true,
    topic: "Clinical Approach & Workup of Watering (Epiphora)"
  },
  {
    id: "gno_lacrimal_dacryo_q1",
    chapterId: 2,
    type: "short-answer",
    title: "Lacrimal Fistula Pathology and Management",
    content: "Describe the pathogenesis of a lacrimal fistula and state its surgical treatment.",
    answer: `Pathogenesis: A lacrimal fistula occurs when an untreated acute dacryocystitis abscess breaks through the overlying skin (below the medial palpebral ligament) to drain pus. The tract becomes lined with epithelium, preventing spontaneous closure.

Treatment: Surgical excision of the fistulous tract (Fistulectomy) combined with Dacryocystorhinostomy (DCR) to restore proper tear drainage into the nose.`,
    isClinical: true,
    topic: "Acute & Chronic Dacryocystitis"
  },
  {
    id: "gno_lacrimal_gland_q1",
    chapterId: 2,
    type: "short-answer",
    title: "Mikulicz's Syndrome vs. Sjogren's Syndrome",
    content: "Contrast Mikulicz's Syndrome and Sjogren's Syndrome regarding clinical features and gland involvement.",
    answer: `- Mikulicz's Syndrome: Symmetrical, elastic, painless enlargement of the lacrimal and salivary glands, usually representing benign lymphoepithelial lesions or lymphoma. It is not associated with systemic dryness.
- Sjogren's Syndrome: A chronic systemic autoimmune disease causing lymphocytic infiltration, atrophy, and fibrosis of the lacrimal and salivary glands. It presents with severe dry eyes (keratoconjunctivitis sicca) and dry mouth (xerostomia), often associated with connective tissue diseases (like rheumatoid arthritis).`,
    isClinical: true,
    topic: "Anatomy & Diseases of the Lacrimal Gland"
  },
  {
    id: "gno_lacrimal_gland_q2",
    chapterId: 2,
    type: "short-answer",
    title: "Clinical Signs of Lacrimal Gland Swelling",
    content: "Describe the typical clinical presentation of a patient with a lacrimal gland swelling (tumor or chronic inflammation).",
    answer: `1. Swelling Location: Located in the upper-temporal quadrant of the eyelid, presenting as a palpable mass below the outer orbital margin with an S-shaped deformity of the lid and mechanical ptosis.
2. Globe Displacement: The eyeball is mechanically pushed downward and inward (medially).
3. Motility Limitation: Limitation of ocular movement in the upward and outward (temporal) direction, which may cause diplopia.`,
    isClinical: true,
    topic: "Anatomy & Diseases of the Lacrimal Gland"
  },

  // --- Chapter 3: Conjunctiva (10 Questions) ---
  {
    id: "gno_conjunctiva_anatomy_q1",
    chapterId: 3,
    type: "short-answer",
    title: "Histological Structure of the Conjunctiva",
    content: "Describe the histological layers of the conjunctiva.",
    answer: `The conjunctiva consists of two histological layers:
1. The Epithelium: Non-keratinized stratified squamous epithelium. It contains goblet cells that secrete the inner mucin layer of the tear film.
2. The Substantia Propria: Composed of:
   - Superficial adenoid layer: Loose connective tissue containing leukocytes. (Note: develops only after 3-4 months of life).
   - Deep fibrous layer: Denser connective tissue containing blood vessels and nerves.`,
    isClinical: false,
    topic: "Anatomy, Histology & Vessels of the Conjunctiva"
  },
  {
    id: "gno_conjunctiva_anatomy_q2",
    chapterId: 3,
    type: "short-answer",
    title: "Vascular Supply and Lymphatic Drainage of the Conjunctiva",
    content: "Describe the arterial supply and lymphatic drainage pathways of the conjunctiva.",
    answer: `Arterial Supply:
- Anterior conjunctival arteries: Branches of the anterior ciliary arteries.
- Posterior conjunctival arteries: Branches of the palpebral arteries (anastomose freely with anterior conjunctival arteries).

Lymphatic Drainage:
- Lateral part of the conjunctiva: Drains into the preauricular and parotid lymph nodes.
- Medial part of the conjunctiva: Drains into the submandibular (submaxillary) lymph nodes.
- Both systems eventually empty into the upper deep cervical lymph nodes.`,
    isClinical: false,
    topic: "Anatomy, Histology & Vessels of the Conjunctiva"
  },
  {
    id: "gno_conjunctiva_anatomy_q3",
    chapterId: 3,
    type: "short-answer",
    title: "Nerve Supply of the Conjunctiva",
    content: "Mention the nerves responsible for the sensory innervation of the conjunctiva.",
    answer: `- Main conjunctiva (palpebral and fornix): Supplied by branches of the ophthalmic and maxillary nerves (trigeminal CN V), including the supra-orbital, supratrochlear, infratrochlear, lacrimal, and infraorbital nerves.
- Bulbar conjunctiva near the limbus: Supplied by the ciliary nerves.`,
    isClinical: false,
    topic: "Anatomy, Histology & Vessels of the Conjunctiva"
  },
  {
    id: "gno_conjunctiva_trachoma_q1",
    chapterId: 3,
    type: "short-answer",
    title: "Trachoma Stage 2 Subcategories (McCallan)",
    content: "Detail the subcategories of McCallan Stage 2 (T2) established active Trachoma.",
    answer: `Stage T2 (established active trachoma) is characterized by mature soft follicles and papillae. It is subdivided into:
- T2a: Dominated by mature, soft, expressible follicles.
- T2b: Dominated by papillary hypertrophy, further split into:
  * T2b': Marked papillary hypertrophy (small, non-uniform papillae).
  * T2b'': Mixed trachomatous and flat-topped spring catarrh papillae.
- T2c: Active trachoma complicated by acute secondary gonococcal conjunctivitis.
- T2v: Severe plasma cell infiltration and hyaline degeneration of the tarsus and conjunctiva, presenting as Stellwag's brawny edema.`,
    isClinical: true,
    topic: "Trachoma (Egyptian Ophthalmia)"
  },
  {
    id: "gno_conjunctiva_trachoma_q2",
    chapterId: 3,
    type: "short-answer",
    title: "Clinical Types of Trachomatous Pannus",
    content: "Enumerate the five clinical types of Trachomatous Pannus.",
    answer: `1. Thin pannus (pannus tenuis): Mildest form with minimal vessels.
2. Vascular pannus (pannus vasculosus): Dominated by extensive new vessels, minimal cells.
3. Fleshy pannus (pannus carnosus): Dominated by dense cellular infiltration, looking thick and red.
4. Annular pannus (pannus annulosus): Vascularization extending around the entire corneal limbus.
5. Cicatrized pannus (pannus siccus): Healed stage leaving a crescentic whitish opacity in the upper cornea with a serrated edge (nebula ex-pannus) and Herbert's pits.`,
    isClinical: true,
    topic: "Trachoma (Egyptian Ophthalmia)"
  },
  {
    id: "gno_conjunctiva_trachoma_q3",
    chapterId: 3,
    type: "short-answer",
    title: "Trachomatous Corneal Ulcer Characteristics",
    content: "Describe the characteristics and predisposing causes of a Trachomatous corneal ulcer.",
    answer: `Characteristics: Typically superficial, located specifically at the lower border of the active trachomatous pannus. It is linear in shape with a horizontal long axis.

Predisposing Causes:
1. Direct extension of the active trachomatous infiltration from the pannus.
2. Mechanical abrasion caused by inward-turning eyelashes (trichiasis).
3. Abrasion from hard, raised post-trachomatous concretions (PTCs) rubbing the cornea.`,
    isClinical: true,
    topic: "Trachoma (Egyptian Ophthalmia)"
  },
  {
    id: "gno_conjunctiva_trachoma_q4",
    chapterId: 3,
    type: "short-answer",
    title: "Stage-Specific Surgical Interventions in Trachoma",
    content: "State the surgical or manual interventions indicated for different stages of active and chronic Trachoma.",
    answer: `- Stage T2a (large mature follicles): Manual expression (squeezing out the soft contents of the follicles).
- Stage T2b (papillary hypertrophy): Scraping of the papillae using a sharp spoon.
- Stage T3 & T4 (post-trachomatous degenerations/concretions): Mechanical picking of the PTDs and PTCs using a needle.`,
    isClinical: true,
    topic: "Trachoma (Egyptian Ophthalmia)"
  },
  {
    id: "gno_conjunctiva_allergic_q1",
    chapterId: 3,
    type: "short-answer",
    title: "Corneal Manifestations of Spring Catarrh",
    content: "Enumerate the four specific corneal signs and complications associated with Spring Catarrh (VKC).",
    answer: `1. Punctate epithelial keratitis: Scattered white spots on the cornea, known as Keratitis superficialis vernalis of Tobgy.
2. Shield ulcer: Large, shallow, non-infective epithelial macro-erosions in the upper cornea.
3. Cupid's bow: A transverse corneal opacity resembling senile arcus.
4. Pseudo-gerontoxon: A crescentic lipid deposit at the limbus resembling gerontoxon, associated with resolved limbal spring catarrh.`,
    isClinical: true,
    topic: "Allergic Conjunctivitis (Spring Catarrh & Phlyctenular)"
  },
  {
    id: "gno_conjunctiva_allergic_q2",
    chapterId: 3,
    type: "short-answer",
    title: "Phlyctenular Keratoconjunctivitis Clinical Types",
    content: "Enumerate and describe the clinical forms of Phlyctenular Keratoconjunctivitis based on anatomical involvement.",
    answer: `1. Simple phlyctenular conjunctivitis: Round, elevated, greyish nodule (1-3 mm) on the bulbar conjunctiva or limbus, surrounded by localized injection.
2. Corneal phlycten: A phlyctenular nodule presenting on the cornea (usually starting at the limbus).
3. Phlyctenular corneal ulcer:
   - Marginal phlyctenular ulcer: A single limbal ulcer.
   - Ring ulcer: Coalescence of multiple limbal ulcers around the circumference (highly dangerous).
4. Phlyctenular pannus: Cellular infiltration and superficial vascularization of the cornea (differentiated from trachomatous pannus by being non-limited to the upper part).`,
    isClinical: true,
    topic: "Allergic Conjunctivitis (Spring Catarrh & Phlyctenular)"
  },
  {
    id: "gno_conjunctiva_symblepharon_q1",
    chapterId: 3,
    type: "short-answer",
    title: "Prophylactic Management of Symblepharon",
    content: "Outline the prophylactic treatment measures used to prevent the development of Symblepharon.",
    answer: `1. Mechanical Sweeping: Frequently passing a glass rod coated with antibiotic ointment deep into the conjunctival fornices to break down early fibrinous adhesions.
2. Topical Corticosteroids: Administering steroid eye ointment to suppress active inflammation and check subconjunctival fibrosis.
3. Physical Barrier: Inserting a contact shell (scleral shell) into the conjunctival sac to keep the palpebral and bulbar surfaces separated during healing.`,
    isClinical: true,
    topic: "Conjunctival Degenerations & Symblepharon (Pterygium & Pinguecula)"
  }
];
