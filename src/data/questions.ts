...
export const INITIAL_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    "answer": "1. ==Severe ectropion or structural lid coloboma (MCQ)==.\n2. ==Lower motor neuron facial nerve palsy (CN VII palsy) (MCQ)==.\n3. ==Proptosis (e.g., from Graves' thyroid orbitopathy) (MCQ)== / Spastic lid retraction.\n4. Postoperative overcorrection of ptosis.\n*Note*: Lagophthalmos is NOT caused by ==Severe Entropion (MCQ)==.",
    "isClinical": false,
    "topic": "Lagophthalmos"
  },
  {
  ...
  },
  {
    ...
    "content": "Detail the causative organism, modes of transmission, clinical features, and list the four disorders presenting with preauricular lymphadenopathy.",
  ...
  },
  {
    ...
    "content": "Define Trachoma and mention its causative agent, endemic serotypes, and primary vector of transmission.",
    "answer": "- **Definition**: A chronic infective keratoconjunctivitis characterized by follicles, papillae, and pannus, which heals uniquely by cicatrization (scarring).\n- **Causative Agent**: *Chlamydia trachomatis*.\n- **Endemic Serotypes**: ==Serotypes A, B, Ba, and C (MCQ)== (associated with endemic blindness). Note: Serotypes D-K cause inclusion conjunctivitis, while L1-L3 cause lymphogranuloma venereum.\n- **Transmission Vector**: ==Flies (Musca sorbens) (MCQ)== play the primary vector role in transmitting infected ocular discharge.",
    "isClinical": false,
  ...
  },
  {
    ...
    "content": "Define Trachomatous Pannus, explain why it preferentially affects the upper cornea, and list its five clinical types.",
    "answer": "- **Definition**: Cellular infiltration combined with superficial vascularization of the cornea.\n- **Anatomical Site**: Preferentially affects the ==upper cornea (MCQ)== because the upper lid cover provides a ==warmer temperature microenvironment (MCQ)== suitable for Chlamydial replication.\n- **Clinical Types**:\n  1. ==Pannus tenuis (MCQ)==: Minimal thin infiltration (most common, mildest).\n  2. ==Pannus vasculosus (MCQ)==: Highly vascularized with scanty cellular infiltration.\n  3. ==Pannus carnosus (MCQ)==: Fleshy, heavily cellular infiltration with minimal vessels.\n  4. ==Pannus annulosus (MCQ)==: Rare, forms all around the limbal margin.\n  5. ==Pannus siccus (Nebula ex-pannus) (MCQ)==: Healed stage, leaving a thin crescentic white corneal opacity.",
    "isClinical": true,
    "topic": "Trachoma (Egyptian Ophthalmia)"
  },
  {
  ...
  },
  {
    ...
    "content": "Enumerate the eyelid, conjunctival, corneal, and lacrimal complications of chronic Trachoma.",
    "answer": "- **Eyelid**: Trichiasis, ==cicatricial entropion (mainly upper lid) (MCQ)==, and mechanical ptosis (partly due to ==Muller's muscle infiltration== and partly due to heavy lids with follicles/papillae).\n- **Conjunctiva**: ==Conjunctival xerosis (MCQ)== (goblet cell destruction causing dry eye), and posterior ==symblepharon (MCQ)== (shallow fornices).\n- **Cornea**: ==Corneal opacity (MCQ)== (the primary cause of severe vision loss and blindness in endemic trachoma) caused by diffuse corneal nebulae leading to ==irregular astigmatism (MCQ)==, dense leucoma, and corneal xerosis.\n- **Lacrimal**: Chronic dacryocystitis and chronic dacryoadenitis.",
    "isClinical": false,
    "topic": "Trachoma (Egyptian Ophthalmia)"
  },
  {
  ...
  },
  {
    ...
    "content": "Enumerate and describe the three clinical presentation types of Spring Catarrh in detail.",
    "answer": "1. **Palpebral Type** (70%):\n   - Features large, dark red or bluish-white, flat-topped, polygonal papillae arranged in a classic ==\"cobblestone\" pattern (MCQ)== on the **upper tarsal/palpebral conjunctiva**.\n   - Importantly, the ==upper fornix is always completely free (MCQ)== of lesions.\n2. **Bulbar / Limbal Type** (10%):\n   - Features gelatinous, brownish-pink raised masses at the limbus, containing small, diagnostic superficial white spots called ==Trantas spots (MCQ)== (composed of clumps of eosinophils and calcified cellular debris).\n3. **Mixed Type** (20%):\n   - Demonstrates a combination of both palpebral cobblestones and limbal gelatinous changes.",
    "isClinical": false,
    "topic": "Allergic Conjunctivitis (Spring Catarrh & Phlyctenular)"
  },
  {
    ...
    "content": "List the four specific corneal manifestations that can complicate severe Spring Catarrh.",
    "answer": "1. ==Keratitis superficialis vernalis of Tobgy (MCQ)==: Characterized by dusty-looking, tiny white scattered punctate epithelial erosions on the upper cornea.\n2. ==Shield ulcer (MCQ)==: Formed by epithelial macro-erosions (shallow, oval-shaped ulcers in the upper cornea with clean margins).\n3. ==Cupid's bow corneal opacity (MCQ)==: Translucent, crescentic stromal opacity resembling arcus senilis near the limbus.\n4. ==Pseudo-gerontoxon (MCQ)==: A localized lipid deposition resembling a partial arcus senilis, adjacent to healed limbal disease.",
    "isClinical": false,
    "topic": "Allergic Conjunctivitis (Spring Catarrh & Phlyctenular)"
  },
  {
  ...
  },
  {
    ...
    "content": "Enumerate the non-perforated complications of a deeply progressive corneal ulcer.",
    "answer": "1. ==Secondary toxic iridocyclitis (MCQ)==: Induced by diffusion of bacterial toxins and enzymes into the anterior chamber, leading to miosis and synechiae.\n2. ==Secondary glaucoma (MCQ)==: Resulting from mechanical blockage of the trabecular meshwork by inflammatory hypopyon exudates, or development of peripheral anterior synechiae (PAS).\n3. ==Descemetocele (MCQ)==: When necrotizing ulceration destroys the entire stroma, leaving only the tough, elastic Descemet's membrane. Under the effect of normal IOP, it bulges forward as a ==translucent, dark, non-staining central bleb (MCQ)==.\n4. ==Ectatic cicatrization (Keratoectasia) (MCQ)==: Bulging of a thin, scarred cornea under normal or elevated IOP. If iris tissue is incorporated into the scar, it is termed an ==Anterior Staphyloma (MCQ)==.\n5. ==Permanent corneal opacities (MCQ)==: (Nebula, Macula, or Leucoma) which cause severe irregular astigmatism and visual loss.",
    "isClinical": true,
    "topic": "Hypopyon Ulcer (Acute Serpiginous Ulcer)"
  },
  {
  ...
  },
  {
    ...
    "answer": "1. **Definition**: ==Acute suppurative inflammation== of the orbital fibro-fatty tissues posterior to the ==orbital septum (MCQ)==.\n2. **Commonest Source**: Direct extension from adjacent paranasal sinuses, most commonly the ==ethmoid sinus (ethmoiditis) (MCQ)== (due to the thinness of the lamina papyracea).\n3. **Causative Organisms**: Pyogenic bacteria, most commonly ==Staphylococcus aureus (MCQ)== and ==Streptococcus pneumoniae/pyogenes (MCQ)==, as well as Haemophilus influenzae in unvaccinated young children.",
    "isClinical": false,
  ...
  },
  {
    ...
    "answer": "1. **Clinical Symptoms**:\n   - Severe, constant, deep orbital ==pain exacerbated by eye movement (MCQ)==.\n   - Marked reduction in visual acuity, headache, and toxic systemic symptoms like ==high fever (MCQ)== and malaise.\n   - Double vision (==diplopia (MCQ)==).\n2. **Physical Signs**:\n   - **Eyelids & Conjunctiva**: Marked, tender, erythematous swelling of lids with intense ==conjunctival chemosis / congestion (MCQ)==.\n   - **Proptosis**: Significant, rapid, tender, non-pulsatile ==axial proptosis (MCQ)==.\n   - **Ocular Motility**: Complete or partial limitation of eye movements in all directions (==ophthalmoplegia (MCQ)==) due to inflammation/paresis of extraocular muscles.\n   - **Pupil**: May show a sluggish reaction or an ==afferent pupillary defect (RAPD) (MCQ)== if compressive optic neuropathy is developing.",
    "isClinical": false,
    "topic": "Orbital & Preseptal Cellulitis"
  },
  {
  ...
  },
  {
    ...
    "answer": "1. ==Tessellated (Tigeroid) Fundus (MCQ)==: Caused by generalized stretching and thinning of the retinal pigment epithelium (RPE) and choroid, making the underlying dark choroidal vessels highly prominent.\n2. ==Myopic Crescent (MCQ)==: A white, crescent-shaped patch of scleral exposure located most commonly at the ==temporal margin of the optic disc (MCQ)==, resulting from sliding temporal traction of retinal layers away from the disc.\n3. ==Fuchs' Spot (MCQ)==: A dark circular, pigmented spot at the macula representing the scarred, hypertrophied RPE reaction over past subretinal choroidal hemorrhages, secondary to ==Choroidal Neovascularization (CNV) (MCQ)== occurring through tears in Bruch's membrane.\n4. ==Posterior Staphyloma (MCQ)==: A pathognomonic ectasia/backward bulging of the thinned posterior scleral wall, which appears clinically as a deep excavated crater pale white-yellow area containing atrophic choroid and retina.",
    "isClinical": true,
    "topic": "Myopia (Short Sightedness)"
  },
  {
  ...
  },
  {
    ...
    "answer": "1. **Definition**:\n   - A refractive state in which parallel rays of light are brought to a ==focus behind the light-sensitive retina (MCQ)== when the eye's accommodation is ==completely relaxed / suspended (MCQ)==.\n\n2. **Etiological Causes**:\n   - ==Axial Hypermetropia (MCQ)==: Shortness of the antero-posterior axis of the eyeball (most common). *Note*: Infants are normally born with physiological hypermetropia (==physiological infantile hypermetropia (MCQ)==) which gradually reduces to emmetropia by age 7.\n   - ==Curvature Hypermetropia (MCQ)==: Decreased curvature / flattening of the corneal surface (e.g., cornea plana) or lens surfaces.\n   - ==Index Hypermetropia (MCQ)==: Reduced refractive index of the lens nucleus, classically seen in senile ==cortical cataract (MCQ)==, or during tight glycemic control in diabetes.\n   - **Position / Absence of Lens**: ==Posterior dislocation of the lens (MCQ)==, or complete absence of the lens (==Aphakia (MCQ)==).",
    "isClinical": false,
  ...
  },
  {
    ...
    "answer": "1. ==Total Hypermetropia (MCQ)==: The entire refractive error, only measured when the ciliary muscle is completely paralyzed using a potent cycloplegic drug like ==Atropine (MCQ)==.\n2. ==Latent Hypermetropia (MCQ)==: The segment of the error (typically about ==1.00 Diopter (MCQ)==) that is naturally and continuously corrected by the standard physiological tone of the ciliary muscle.\n3. ==Manifest Hypermetropia (MCQ)==: The remaining segment of the error which cannot be corrected by basic ciliary tone alone (calculated as: $\\text{Manifest} = \\text{Total} - \\text{Latent}$).\n4. ==Facultative Hypermetropia (MCQ)==: The part of manifest hypermetropia that the patient can voluntarily correct and overcome by active accommodative effort.\n5. ==Absolute Hypermetropia (MCQ)==: The leftover segment of manifest hypermetropia that cannot be overcome by accommodation (calculated as: $\\text{Absolute} = \\text{Manifest} - \\text{Facultative}$). This component causes constant distance vision blur.",
    "isClinical": false,
    "topic": "Hypermetropia (Far Sightedness)"
  },
  {
  ...
  },
  {
    ...
    "answer": "1. **Definition**:\n   - An error of refraction in which the eye's refractive power is ==unequal in different meridians (MCQ)==, preventing incident parallel light rays from converging to a single point focus on the retina. Instead, light forms a series of focal lines (known as ==Sturm\\'s Conoid (MCQ)==).\n\n2. **Differentiating Regular vs. Irregular Astigmatism**:\n   - ==Regular Astigmatism (MCQ)==:\n     * The two principal (maximum and minimum power) meridians are oriented exactly ==perpendicular ($90^{\\circ}$) to each other (MCQ)==.\n     * The change in curvature/power from one meridian to the next is gradual and consistent.\n     * **Correction**: Easily corrected using standard cylinder spectacles.\n   - ==Irregular Astigmatism (MCQ)==:\n     * The principal meridians are not perpendicular to each other, or the curvature changes erratically along a single meridian.\n     * Commonly caused by local corneal pathology like ==corneal scars / corneal ectasia / Keratoconus (MCQ)==.\n     * **Correction**: Spectacles fail completely; requires ==Rigid Gas Permeable (RGP) contact lenses (MCQ)== or corneal surgical reconstruction (keratoplasty).",
    "isClinical": false,
    "topic": "Astigmatism"
  },
  {
    ...
    "answer": "1. ==Astigmatism With the Rule (WTR) (MCQ)==:\n   - The ==vertical corneal meridian is more curved and powerful (MCQ)== than the horizontal meridian.\n   - This is common in young patients because continuous vertical blinking lid pressure preserves the vertical curvature.\n   - **Spectacle Correction**: Requires a minus cylinder lens placed with the ==axis at $180^{\\circ} \\pm 20^{\\circ}$ (MCQ)== (or a plus cylinder at axis $90^{\\circ}$). \n\n2. ==Astigmatism Against the Rule (ATR) (MCQ)==:\n   - The ==horizontal corneal meridian is more curved and powerful (MCQ)== than the vertical meridian.\n   - Highly common in elderly patients due to senile loss of lid pressure and age-related horizontal corneal changes.\n   - **Spectacle Correction**: Requires a minus cylinder lens placed with the ==axis at $90^{\\circ} \\pm 20^{\\circ}$ (MCQ)== (or a plus cylinder at axis $180^{\\circ}$).",
    "isClinical": false,
    "topic": "Astigmatism"
  },
  {
  ...
  },
  {
    ...
    "content": "Outline the systematic emergency clinical procedures used to manage acute CRAO within the golden therapeutic window.",
    "answer": "CRAO represents a true ocular emergency where irreversible retinal damage occurs after ==90-120 minutes of complete occlusion==. Immediate intervention aims to dislodge the embolus from the central artery into a smaller peripheral branch:\n\n1. ==Digital Ocular Massage (MCQ)==:\n   - Apply steady, firm, repeated hand/finger pressure to the globe to lower IOP and induce rapid mechanical expansion/shearing that dislodges the embolus.\n\n2. ==Anterior Chamber Paracentesis (MCQ)==:\n   - Immediate paracentesis using a fine needle to drain a drop of aqueous fluid, instantly dropping IOP and pulling blood flow forward.\n\n3. ==Lowering IOP Pharmacologically (MCQ)==:\n   - Intravenous ==Acetazolamide (Diamox) 500mg (MCQ)== or topical beta-blockers.\n\n4. ==Inhalation Therapy (MCQ)==:\n   - Breaths of **Carbogen gas** ($95\\%\\ \\text{O}_2, 5\\%\\ \\text{CO}_2$) to induce retinal vasodilatated state and maximize blood oxygen levels.",
    "isClinical": true,
    "topic": "Central Retinal Artery Occlusion (CRAO)"
  },
  {
    ...
    "content": "Define Rhegmatogenous Retinal Detachment (RRD) and outline its high-yield predisposing risk factors.",
    "answer": "1. **Definition of RRD**:\n   - The separation of the neurosensory retina from the underlying retinal pigment epithelium (RPE), driven by fluid passing through a ==full-thickness retinal break (tear or hole) (MCQ)== from the vitreous cavity into the subretinal space.\n\n2. **High-Yield Predispositions (MCQ)==:\n   - ==High Axial Myopia (MCQ)==: Characterized by progressive eyeball expansion that physically thins the peripheral retina.\n   - ==Lattice Degeneration (MCQ)==: Linear areas of peripheral retinal thinning with overlying vitreous liquefaction and strong vitreoretinal attachments.\n   - ==Aphakia or Pseudophakia (MCQ)==: Following cataract surgery (especially if vitreous loss occurred).\n   - Ocular trauma or previous laser capsulotomy.",
    "isClinical": true,
